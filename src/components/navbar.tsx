...
const Navbar: React.FC = () => {
  ...
  return (
    <nav className="bg-gray-900 fixed w-full z-10 top-0 shadow">
      <div className="container mx-auto px-4 py-3 flex items-center justify-between">
        <div className="flex items-center">
          <a href="#" className="text-gray-100 text-base xl:text-xl font-bold no-underline hover:no-underline flex items-center">
        ...
        <div className="hidden md:flex space-x-6">
          {['Home', 'Tasks', 'Messages', 'Analytics'].map((menu, index) => (
            <a
              key={index}
              href="#"
              className={`text-gray-400 hover:text-white relative transition duration-300 after:content-[''] after:absolute after:bottom-[-4px] after:left-0 after:w-full after:h-[2px] after:scale-x-0 after:transition-transform after:duration-300 after:hover:scale-x-100 ${index === 0 ? 'after:bg-blue-400' :
        ...
        <div className="flex items-center space-x-4">
          <div className="relative">
            <input type="search" placeholder="Search" className="w-48 bg-gray-800 text-sm text-gray-400 transition border border-gray-700 focus:outline-none focus:border-gray-600 rounded py-1 px-2 pl-10 appearance-none leading-normal" />
